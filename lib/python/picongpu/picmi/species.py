...
_translation_grid: ContextVar["Cartesian3DGrid | None"] = ContextVar("picongpu_translation_grid", default=None)


@contextmanager
def particle_boundary_translation_context(grid: "Cartesian3DGrid"):

...
_UNION_TEMPLATE_ANCHORS = {
    ...
    AnyPlugin: {
        ...
        FieldEnergyMonitor: ("etc/picongpu/N.cfg.mustache", "{{#type_fieldenergymonitor}}"),
        ...
        ParticleEnergy: ("etc/picongpu/N.cfg.mustache", "{{#type_particleenergy}}"),
    ...
    AnySolver: {
        ...
        CKCSolver: ("include/picongpu/param/fieldSolver.param.mustache", "{{{solver.name}}}"),
        ArbitraryOrderFDTDSolver: ("include/picongpu/param/fieldSolver.param.mustache", "{{{solver.name}}}"),
        NoneSolver: ("include/picongpu/param/fieldSolver.param.mustache", "{{{solver.name}}}"),
    },
    AnyLayout: {
